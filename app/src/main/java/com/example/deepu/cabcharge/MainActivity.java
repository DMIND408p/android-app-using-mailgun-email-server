...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText ccTextTo;
    private EditText bccTextTo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ccTextTo = findViewById(R.id.ccTo);
        bccTextTo = findViewById(R.id.BccTo);
    ...
    private void sendEmail() {
        ...
        String cc = editTextFrom.getText().toString().trim();
        String bcc = editTextFrom.getText().toString().trim();
